...
Le firmware Marlin 2.0.x bugfix pour pour Artillery Sidewinder X1 configuré pour cet écran se trouve [ici](https://github.com/Guilouz/Marlin-Sidewinder-X1-SKR1.4-Turbo)
