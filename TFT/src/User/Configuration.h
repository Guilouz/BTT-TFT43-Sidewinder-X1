...
#define ENABLE_CTRL_FAN 0  // Set 0 to disable & 1 to enable controller fan speed control for Idle and Active
...
#define PREHEAT_HOTEND {210,   230,    240,   200,    220,   250}
#define PREHEAT_BED    { 65,    70,     90,    60,     60,    90}

// Heat
#define HEAT_MAX_TEMP   {275,       275,       275,       275,       275,       275,       130,    60}
...
#define NOZZLE_PAUSE_XY_FEEDRATE                300  // (mm/min) X and Y axes feedrate
...
#define LEVELING_POINT_XY_FEEDRATE  300  // (mm/min) X and Y axes move feedrate
...
#define LCD_IDLE_BRIGHTNESS  6  // LCD brightness level when device is idle (Default: 3)
